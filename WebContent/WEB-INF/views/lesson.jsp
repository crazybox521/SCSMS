...
<body>
	<div class="container">
		...
		<div class="layui-row layui-col-space20" id="lessonlist">
		</div>
		<br>
		<br>
	     ...
	     <div id="loginBox">
         <form class="layui-form layui-form-pane" action="login"   method="post"  target="_parent">
	...
	$.ajax({
		...
		success:function(data){
			...
			$.each(data.data,function(i,item){
				    ...
				    str+="<div class='btn'><button type='button' class='layui-btn layui-btn-danger' onclick='ShowLoginView();'>登录报名班级</button></div>";
