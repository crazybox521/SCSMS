...
<c:if test="${not empty sessionScope.student}">
	<div class="container">
		<div class="display">
     	...
     	<button class="layui-btn layui-btn-primary" style="margin:10px;" onclick="list1()">风格1</button>
     	<button class="layui-btn layui-btn-primary" style="margin:10px;" onclick="list()">风格2</button>
			<div id="list" >
			</div>
			</div>
		</div>
