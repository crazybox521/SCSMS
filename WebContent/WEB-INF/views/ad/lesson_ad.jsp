		...
		<div class="content">
			<div class="demoTable">
				...
				<div class="layui-inline layui-form">
					<input class="layui-input" name="id" id="demoReload" autocomplete="off" lay-verify="number">
				</div>
				<button class="layui-btn" data-type="reload"><i class="layui-icon">&#xe615;</i> 搜索</button>
				<a href="javascript:;" id="addBtn"
					class="layui-btn layui-btn-radius" onclick="ShowAddText()"><i
		...
		<div id="addBox">
		    <form class="layui-form layui-form-pane" action="" method="post">
		        ...
		        <div class="layui-form-item">
		          ...
		          <div class="layui-input-block">
		            <input type="text" name="hours" required lay-verify="required|number|test" placeholder="请输入学时" autocomplete="off" class="layui-input">
		          </div>
		        </div>
		        <div class="layui-form-item">
		          <label class="layui-form-label">定价¥</label>
		          <div class="layui-input-block">
		            <input type="text" name="price" required lay-verify="required|number|test" placeholder="请输入价格" autocomplete="off" class="layui-input">
		          </div>
		        </div>
		         <div class="layui-form-item layui-form-text">
        			 <label class="layui-form-label">课程说明</label>
       				 <div class="layui-input-block" >
           			 <textarea name="notes" placeholder="请输入课程说明" class="layui-textarea" style="max-height:150px;"></textarea>
          		</div>
        		</div>
    ...
    <div id="editBox">
      <form class="layui-form layui-form-pane" action="" lay-filter="form2">
          ...
          <div class="layui-input-inline">
            <input type="text" name="id" readonly="readonly" value="${ sessionScope.student.userName}" class="layui-input">
          </div>
        ...
        <div class="layui-form-item">
          <label class="layui-form-label">学时</label>
          <div class="layui-input-block">
            <input type="text" name="hours" required lay-verify="required|number" placeholder="请输入学时" autocomplete="off" class="layui-input">
          </div>
        </div>
        ...
        <div class="layui-form-item">
          <label class="layui-form-label">定价¥</label>
          <div class="layui-input-block">
            <input type="text" name="price" required lay-verify="required|number placeholder="请输入定价" autocomplete="off" class="layui-input">
          </div>
        </div>
