			...
			<form class="layui-form layui-form-pane" action="" method="post" lay-filter="form_addgrade">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<select name="lesson" lay-verify="required" id="addlesson" lay-filter="form_addgradelesson">
				...
				<div class="layui-form-item">
				      ...
				      <div class="layui-input-inline">
				        <input type="text" name="starttime" class="layui-input" id="time1" required lay-verify="required" placeholder="yyyy-MM-dd">
				      </div>
				 </div>
				 <div  class="layui-form-item">
				 	<label class="layui-form-label">结束时间</label>
				      <div class="layui-input-inline">
				        <input type="text" name="endtime" class="layui-input" id="time2" required lay-verify="required" placeholder="yyyy-MM-dd">
				      </div>
				 </div>
